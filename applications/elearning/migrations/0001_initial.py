# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-25 07:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='title of the course', max_length=10, verbose_name='title')),
        ...
        migrations.AddField(
            model_name='location',
            name='address',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='gps', to='elearning.UserProfile'),
        ),
        migrations.AddField(
            model_name='comment',
            name='course',
